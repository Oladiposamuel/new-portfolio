...
Command: npx gltfjsx@6.0.9 Avatar.glb
*/
...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <skinnedMesh position={[0, Math.PI, 0]} geometry={nodes.Wolf3D_Body.geometry} material={materials.Wolf3D_Body} skeleton={nodes.Wolf3D_Body.skeleton} />
